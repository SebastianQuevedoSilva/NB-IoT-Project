...
// MQTT
String clientID = "111";
String userBroker = "robertsen";
String passwordBroker = "";
String broker = "34.229.172.176";
int port = 1883;

// msg
String topic1 = userBroker + "/feeds/temperatura";
String topic2 = userBroker + "/feeds/humedad";
String topic3 = userBroker + "/feeds/ppm";
String topic4 = userBroker + "/feeds/bateria";
float batery;
...
void loop()
{
    ...
    */
    sk.SendMessage(temp, topic1, 2, 0, 0, 0, 10000); // Se envia el mensaje
    delay(2000);

    sk.SendMessage(hum, topic2, 2, 0, 0, 0, 10000); // Se envia el mensaje
    delay(2000);

    sk.SendMessage(String(sensorPPM), topic3, 2, 0, 0, 0, 10000); // Se envia el mensaje
    delay(2000);

    sk.SendMessage(String(batery), topic4, 2, 0, 0, 0, 10000); // Se envia el mensaje
    delay(60000);
}
